...
{
    public class JwtHandler(IConfiguration configuration, UserManager<AnimeVoiceactorCharacterUser> userManager)
    {
        public async Task<JwtSecurityToken> GetTokenAsync(AnimeVoiceactorCharacterUser user) =>
        new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(AnimeVoiceactorCharacterUser user)
        {
